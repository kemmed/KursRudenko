...
{
    internal class ProductsInSaleViewModels
    {
        private readonly Kurs2RudenkoContext _context;
        public int Id { get; set; }
        public string name { get; set; } = "";
        public int count { get; set; }
        public ProductsInSaleViewModels(int Id, Kurs2RudenkoContext kurs2RudenkoContext)
        {
            _context = kurs2RudenkoContext;
            this.Id = Id;
            this.count = _context.SaleProds.FirstOrDefault(x=>x.ProductId==Id).Count;
